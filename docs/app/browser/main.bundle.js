...
`;var w=class extends n{static get observedAttributes(){return["url","image","tags"]}template(){let e="500px",s=this.attrs.url?`href="${this.attrs.url}" onclick=""`:'href="" onclick="event.preventDefault()"',t=this.attrs.image||"",o="";if(this.attrs.tags)for(let r of this.attrs.tags.split(","))r=r.trim(),r&&(o+=`<span>${r}</span>`);return`
            <style>
            ${a}
            ${k}
            ${c}
            ...
            :host {
                ...
                background: var(--color-surface) url(${t}) no-repeat center center / cover;
